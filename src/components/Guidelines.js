...
export default class Guidelines extends React.Component {
  render() {
    return (
      <div>
        <div className="ui huge header">Guidelines to Follow to Stay Safe</div>
        <div>
          <div className="ui segment">
            <div className="ui medium header">Wash your hands frequently</div>
          ...
          <div className="ui segment">
            <div className="ui medium header">Maintain social distancing</div>
          ...
          <div className="ui segment">
            <div className="ui medium header">Practice respiratory hygiene</div>
          ...
          <div className="ui segment">
            ...
            and others from COVID-19. Why? National and local authorities will
